    ...
    <div className="w-full pb-12 relative">
      ...
      <div className="mb-10 max-w-7xl mx-auto flex flex-col xl:flex-row xl:items-end justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Link href="/create-pattern?tab=pdf" className="px-5 py-3 bg-gradient-to-r from-emerald-500 to-green-500 text-white rounded-2xl font-bold text-[13px] shadow-lg shadow-emerald-200/50 hover:shadow-xl hover:shadow-emerald-300/50 hover:-translate-y-0.5 active:scale-[0.98] transition-all flex items-center gap-2">
