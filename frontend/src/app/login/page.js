...
import { Eye, EyeOff, ArrowRight, AlertCircle, CheckCircle2, GraduationCap, Sparkles, Wrench, X } from 'lucide-react';
    ...
    >
        ...
        {billingDest && (
          <motion.div
            ...
            style={{
              ...
              background: 'rgba(15,14,13,0.5)', backdropFilter: 'blur(4px)',
              padding: '1rem', fontFamily: 'var(--l-sans)',
            }}
          >
            <motion.div
              ...
              style={{
                ...
                boxShadow: '0 30px 80px rgba(15,14,13,0.25), 0 2px 10px rgba(15,14,13,0.05)',
              }}
            >
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14, padding: '1.5rem 1.5rem 1.25rem' }}>
                <div style={{ flexShrink: 0, width: 40, height: 40, background: '#fef2f2', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <AlertCircle size={20} style={{ color: '#ef4444' }} />
                </div>
                <div style={{ flex: 1 }}>
                  <h3 style={{ fontFamily: 'var(--l-serif)', fontStyle: 'italic', fontWeight: 800, fontSize: '1.25rem', color: '#0f0e0d', margin: 0, letterSpacing: '-0.02em' }}>
                    Billing Period Over
                  </h3>
                  <p style={{ fontSize: '0.875rem', color: '#6b6560', margin: '8px 0 0', lineHeight: 1.6 }}>
                ...
                <button
                  ...
                  aria-label="Dismiss"
                  style={{ flexShrink: 0, background: 'none', border: 'none', cursor: 'pointer', color: '#9c9590', padding: 4, borderRadius: 8, display: 'flex', alignItems: 'center' }}
              ...
              <div style={{ padding: '0.875rem 1.5rem', background: '#faf9f7', borderTop: '1px solid rgba(0,0,0,0.06)', display: 'flex', justifyContent: 'flex-end' }}>
                <motion.button
                  whileHover={{ scale: 1.02, backgroundColor: '#2a2826' }}
                  whileTap={{ scale: 0.98 }}
                  onClick={continueToApp}
                  style={{ padding: '0.625rem 1.25rem', background: '#0f0e0d', color: '#faf9f7', border: 'none', borderRadius: 10, fontSize: '0.875rem', fontWeight: 700, cursor: 'pointer', fontFamily: 'var(--l-sans)', letterSpacing: '-0.01em', transition: 'background-color 0.2s' }}
                >
      ...
      <div style={{
        ...
        >
          ...
          {/* Dev Notes — recent fixes shipped (restyled to qForge look) */}
          <motion.div variants={fadeUp} style={{
            marginTop: '2rem',
            width: '100%',
            background: '#ffffff',
            ...
            borderRadius: 16,
            padding: '1.5rem',
            boxShadow: '0 4px 20px rgba(15,14,13,0.03)',
          }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: '1.25rem' }}>
              <div style={{ width: 32, height: 32, background: '#faf9f7', border: '1px solid #e2ddd7', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Wrench size={15} style={{ color: '#6b6560' }} />
              </div>
              <h2 style={{ fontSize: '0.9375rem', fontWeight: 700, color: '#0f0e0d', margin: 0, letterSpacing: '-0.01em' }}>Dev Notes</h2>
            </div>
            <ol style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <li style={{ display: 'flex', gap: 12 }}>
                ...
                <div>
                  <p style={{ fontSize: '0.875rem', fontWeight: 600, color: '#0f0e0d', margin: 0 }}>Paper header fixed</p>
                  <p style={{ fontSize: '0.75rem', color: '#9c9590', margin: '2px 0 0', lineHeight: 1.55 }}>
              ...
              <li style={{ display: 'flex', gap: 12 }}>
                <CheckCircle2 size={18} style={{ color: '#16a34a', flexShrink: 0, marginTop: 2 }} />
                <div>
                  <p style={{ fontSize: '0.875rem', fontWeight: 600, color: '#0f0e0d', margin: 0 }}>Chapter inconsistency fixed</p>
                  <p style={{ fontSize: '0.75rem', color: '#9c9590', margin: '2px 0 0', lineHeight: 1.55 }}>
              ...
              <li style={{ display: 'flex', gap: 12 }}>
                ...
                <div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <p style={{ fontSize: '0.875rem', fontWeight: 600, color: '#0f0e0d', margin: 0 }}>Report an Issue</p>
                    <span style={{ display: 'inline-flex', padding: '2px 6px', borderRadius: 999, fontSize: '0.625rem', fontWeight: 600, background: '#eef2ff', color: '#4f46e5' }}>New</span>
                  </div>
                  <p style={{ fontSize: '0.75rem', color: '#9c9590', margin: '2px 0 0', lineHeight: 1.55 }}>
